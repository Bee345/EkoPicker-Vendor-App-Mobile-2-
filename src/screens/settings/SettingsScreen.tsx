  ...
  const rows: { section: string; items: SettingsRow[] }[] = [
    {
      ...
      items: [
        ...
        },
        {
          ...
          toggle: false,
          action: () => Alert.alert('Coming Soon', '2FA is coming in a future update.'),
        },
      ],
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          sub: 'English (Default)',
          toggle: false,
          action: () => Alert.alert('Coming Soon', 'Language settings are coming soon.'),
        },
        {
          icon: 'notifications-outline',
          label: 'Push Notifications',
          sub: 'Manage system notifications',
          toggle: false,
          action: () => Alert.alert('Info', 'Manage from your device settings.'),
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          sub: 'Export your data as CSV',
          toggle: false,
          action: () => Alert.alert('Processing', 'Your data export will be emailed to you.'),
        },
        {
          icon: 'trash-outline',
          ...
          toggle: false,
          action: () => Alert.alert('Danger', 'Please contact support to delete your account.'),
        },
      ],
    },
    {
