  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        screen: SCREENS.CHANGE_PASSWORD,
        color: '#FFF1F2',
        iconColor: '#F43F5E',
      },
      {
      ...
      <View style={styles.section}>
        ...
        <View style={styles.sectionCard}>
          <View style={styles.menuItem}>
            <View
              style={[styles.menuIcon, { backgroundColor: isDarkMode ? '#1E293B' : '#FEF9C3' }]}
            >
              <Ionicons
                name={isDarkMode ? 'moon' : 'sunny'}
                size={18}
                color={isDarkMode ? '#FACC15' : '#F59E0B'}
              />
            </View>
