...
import {
  View, Text, FlatList, TouchableOpacity, StyleSheet, Dimensions, ListRenderItemInfo,
} from 'react-native';
...
const SLIDES = [
  {
    ...
    subtitle: 'List products, accept orders, and grow your revenue — all from one powerful dashboard.',
    color: '#EEF2FF',
  ...
  },
  {
    ...
    subtitle: 'Communicate directly with your buyers. Build trust and deliver great customer service.',
    color: '#F0FDF4',
    iconBg: '#10B981',
  },
  {
...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 28, fontWeight: '900', color: COLORS.primary, textAlign: 'center', marginBottom: 14, letterSpacing: -0.5 },
