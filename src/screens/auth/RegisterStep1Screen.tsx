...
const BUSINESS_TYPES: {
...
}[] = [
  {
    ...
    icon: 'restaurant',
    description: 'Meals, drinks, snacks, catering',
    color: '#FFF7ED',
  },
  {
    type: 'retail',
    label: 'Retail Store',
    icon: 'bag-handle',
    description: 'Groceries, electronics, fashion',
    color: '#EFF6FF',
  },
  {
    type: 'pharmacy',
    label: 'Pharmacy',
    icon: 'medkit',
    description: 'Drugs, supplements, medical supplies',
    color: '#F0FDF4',
  },
  {
    type: 'orders',
    ...
    icon: 'cube',
    description: 'Bulk goods, raw materials, spare parts',
    color: '#F5F3FF',
  },
  {
    type: 'others',
    ...
    icon: 'storefront',
    description: 'Any other product or service type',
    color: '#FFF1F2',
  },
];
    ...
    <SafeScreen>
      <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
        ...
        <Text style={styles.subtitle}>
          We'll customise the app experience for your business type.
        </Text>
            ...
            return (
              <TouchableOpacity
                ...
                style={[
                  ...
                  { backgroundColor: isSelected ? COLORS.primary : bt.color },
                ]}
              >
                <View
                  style={[
                ...
                <View style={styles.cardText}>
                  ...
                  <Text
                    style={[styles.cardDesc, isSelected && { color: 'rgba(255,255,255,0.65)' }]}
                  >
                    {bt.description}
                  </Text>
                </View>
