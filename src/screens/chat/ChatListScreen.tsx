...
export function ChatListScreen() {
  ...
  const renderChat = ({ item }: { item: Chat }) => (
    <TouchableOpacity
      activeOpacity={0.85}
      onPress={() => navigation.navigate(SCREENS.CHAT_CONVERSATION, {
        chatId: item._id,
      ...
      <FlatList
        ...
        ListEmptyComponent={
          isLoading
            ...
            : <EmptyState icon="💬" title="No conversations yet" subtitle="Chats with your customers will appear here after they order from you." />
        }
      />
    </SafeScreen>
  );
...
const styles = StyleSheet.create({
  ...
  card: { flexDirection: 'row', alignItems: 'center', gap: 14, paddingVertical: 14, paddingHorizontal: 4, borderBottomWidth: 1, borderBottomColor: '#F1F5F9' },
