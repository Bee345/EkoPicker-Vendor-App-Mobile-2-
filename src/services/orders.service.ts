...
const MOCK_ORDERS: Order[] = [
  {
    ...
    items: [
      {
        ...
        productImage: 'https://picsum.photos/seed/headphones/200/200',
        quantity: 1,
        price: 45000,
      },
      {
        ...
        productImage: 'https://picsum.photos/seed/tea/200/200',
        quantity: 2,
        price: 2500,
      },
    ],
    ...
    status: 'pending',
    deliveryAddress: {
      fullAddress: '23 Adeola Odeku St, Victoria Island',
      city: 'Lagos',
      state: 'Lagos',
    ...
    items: [
      {
        ...
        productImage: 'https://picsum.photos/seed/biscuits/200/200',
        quantity: 3,
        price: 3500,
      },
    ],
  ...
  },
  {
    ...
    items: [
      {
        productId: 'p5',
        productName: 'Bluetooth Smart Watch',
      ...
      },
      {
        ...
        productImage: 'https://picsum.photos/seed/water/200/200',
        quantity: 2,
        price: 1800,
      },
    ],
  ...
  },
  {
    ...
    user: {
      ...
      name: 'Venti Bard',
      phone: '+2348044444444',
      avatar: 'https://i.pravatar.cc/100?u=u4',
    },
    items: [
      {
        productId: 'p3',
        productName: 'Liquid Laundry Detergent',
        productImage: 'https://picsum.photos/seed/detergent/200/200',
        quantity: 4,
        price: 5500,
      },
    ],
  ...
  async getDashboardStats() {
    if (USE_MOCK) {
      ...
      return {
        ...
        totalRevenue: MOCK_ORDERS.filter((o) => o.paymentStatus === 'paid').reduce(
          (sum, o) => sum + o.total,
          0,
        ),
      };
