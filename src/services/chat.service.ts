  ...
  chat_001: [
    {
      ...
      senderId: 'u1',
      senderType: 'user',
      text: 'Hi, I just placed an order. Can you confirm?',
      read: true,
    ...
    },
    {
      ...
      senderId: 'vendor_001',
      senderType: 'vendor',
      text: 'Hi Raiden! Yes, I can see your order. Let me confirm it now.',
      read: true,
    ...
    },
    {
      ...
      senderId: 'vendor_001',
      senderType: 'vendor',
      text: "Order #212323 confirmed! We'll start preparing it shortly.",
      read: true,
    ...
    },
    {
      ...
      senderId: 'u1',
      senderType: 'user',
      text: 'Great, thank you! How long will it take?',
      read: true,
  ...
  chat_002: [
    {
      ...
      senderId: 'u2',
      senderType: 'user',
      text: 'Hello! I placed an order for biscuits.',
      read: true,
...
export const chatService = {
  ...
  async sendMessage(dto: SendMessageDto): Promise<Message> {
    ...
    const { data } = await apiClient.post<Message>(`/vendor/chats/${dto.chatId}/messages`, {
      text: dto.text,
    });
    return data;
  },
